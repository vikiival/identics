...
export const clearIdentity = {
   ...
   *  # </weight>
   */
  v5: new CallType('Identity.clear_identity', sts.unit()),
}
...
export const quitSub = {
   ...
   */
  v15: new CallType('Identity.quit_sub', sts.unit()),
}
...
export const addUsernameAuthority = {
  ...
  v1002000: new CallType(
    ...
    sts.struct({
      authority: v1002000.MultiAddress,
      suffix: sts.bytes(),
...
export const setUsernameFor = {
  ...
  v1002000: new CallType(
    ...
    sts.struct({
      who: v1002000.MultiAddress,
      username: sts.bytes(),
      signature: sts.option(() => v1002000.MultiSignature),
    })
  ),
}
