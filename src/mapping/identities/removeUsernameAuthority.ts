...
import { getAddSubCall, getRemoveUsernameAuthorityCall, getSetIdentityCall, getSetSubsCall } from "../getters"
 ...
 **/
export async function handleUsernameAuthorityRemove(context: Context): Promise<void> {
