...
import { onlyValue, addressOf, unHex } from '../src/utils/helper'
...
describe('Helpers', () => {
  ...
  describe('addressOf', () => {
    it('should return a value', () => {
      const value = addressOf(
        '0x30658243d02e18551f0d447dad1065db75b01e570fd47eec86805dbea12a28ed'
      )
      expect(value).toBe('126TTGXfwo135HpckqxLaUievV9vANqdGV3K4GjRoDQGbfTD')
    })
    ...
    test('should throw on invalid', () => {
      ...
      try {
        addressOf(
          '0x30658243d02e18551f0d447dad1065db75b01e570fd47eec86805dbea12a28e'
        )
      } catch (error) {
